...
The externally generated Meshy Budka trader hut, Papug parrot, hero mission board, Verstak salvage workbench and Lodka boat establish the preferred starting-base quality: semi-stylized but believable, between stylized game art and realism, rich PBR, detailed hero assets, neither toy-like/cheap low-poly nor photorealistic. These assets supersede older primitive/procedural hub visuals as the reference. Preserve their quality and let nearby framing/composition improve toward it; do not restyle them downward. Moderate local rendering cost is acceptable with measurements and scalable settings. This authorizes their focused hub integration, not a broad world-art pass or M2.

The Director-approved Meshy Deck, Dock and coastal salvage Crane modules are now canonical environment anchors alongside those five heroes. Use them as one coherent working-base composition: Budka for trade, the board for expedition jobs, Verstak for sorting, Deck for the readable base floor, Dock for the sea connection, Lodka for working coastal identity and Crane for unloading. Preserve believable semi-stylized proportions, rich PBR treatment, open traversal space and clear interactions. The Crane is a salvage winch/crane, not a tide gauge or tide-instrument system. This focused environment pass does not authorize renderer expansion, boat gameplay, new mechanics, a broad world-art pass or M2.
